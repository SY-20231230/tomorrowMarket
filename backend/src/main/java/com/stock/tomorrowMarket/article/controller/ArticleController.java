...
public class ArticleController {
    ...
    @Operation(summary = "단일 기사 상세 조회", description = "특정 기사의 상세 정보를 조회합니다.")
    ...
    @Operation(summary = "특정 종목 뉴스 조회", description = "특정 종목에 관련된 뉴스를 조회합니다.")
    ...
    @Operation(summary = "특정 산업군 뉴스 조회", description = "특정 산업군에 관련된 뉴스를 조회합니다.")
    ...
    public ResponseEntity<ApiResponse<com.stock.tomorrowMarket.article.dto.SentimentStatisticsResponse>> getSentimentStatistics(
            @RequestParam(required = false) Long stockId,
            @RequestParam(required = false) Long sectorId
    ) {
